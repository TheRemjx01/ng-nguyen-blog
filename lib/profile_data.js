...
baseProfile.shortDescription = "Hi there! I'm Nghia, another full-stack developer! I have 3.5 years in web development under ReactJS, Golang, and NodeJS. But that's just half of my story, I started my career as an R&D expertise in Unilever and that bring me the full insight into customer behavior, all aspects of a successful product. With all these lessons, I always try to broaden my knowledge not only in the technical problem but also in the practice business story. I'm also the founder of a small tech team (#KaizenAsia) so if you are also interested in the entrepreneur or start-up, please don't hesitate to call me for a coffee. :)"
